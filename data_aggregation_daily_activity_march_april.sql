CREATE OR REPLACE TABLE `bellabeat-case-study-477815.Fitabase_Data_mars_april_2016.overview_stats` AS
SELECT 
...
FROM 
  `bellabeat-case-study-477815.Fitabase_Data_mars_april_2016.dailyActivity_cleaned`;

CREATE OR REPLACE TABLE 
  `bellabeat-case-study-477815.Fitabase_Data_mars_april_2016.steps_by_day` AS
SELECT 
...
CREATE OR REPLACE TABLE 
  `bellabeat-case-study-477815.Fitabase_Data_mars_april_2016.intensity_distribution` AS
SELECT 
  ROUND(AVG(VeryActiveMinutes)) AS avg_very_active_min,
...
CREATE OR REPLACE TABLE 
  `bellabeat-case-study-477815.Fitabase_Data_mars_april_2016.steps_calories_corr` AS
SELECT 
...
CREATE OR REPLACE TABLE 
  `bellabeat-case-study-477815.Fitabase_Data_mars_april_2016.user_activity_levels` AS
SELECT 
  Id,
